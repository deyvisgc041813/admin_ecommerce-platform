...
export const MENU: MenuItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      {
        id: 2,
        label: "Modulos y roles",
        link: "/admin-roles-and-modules",
        parentId: 1,
      },
      {
        id: 3,
        label: "Modulos y Permisos",
        link: "/admin-role-modules-permissions",
        parentId: 1,
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      {
        id: 5,
        label: "Gestión del Menú Superior",
        link: "/parent-menu",
        parentId: 3,
      },
    ],
  },
  {
    ...
    subItems: [
      ...
      {
        id: 4,
        label: "Navegación Ecomerce",
        link: "/menu-home",
        parentId: 4,
      },
      {
        id: 5,
        label: "Configuración Servicios",
